...
class StoreWordImmediatePostIndexedTest: public ArmTest {};

TEST_F(StoreWordImmediatePostIndexedTest, ZeroOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $11223344",
...
TEST_F(StoreWordImmediatePostIndexedTest, PositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $11223344",
...
TEST_F(StoreWordImmediatePostIndexedTest, NonAlignedPositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $11223344",
...
TEST_F(StoreWordImmediatePostIndexedTest, NegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $11223344",
...
TEST_F(StoreWordImmediatePostIndexedTest, NonAlignedNegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $11223344",
...
TEST_F(StoreWordImmediatePostIndexedTest,
