...
class LoadWordImmediatePostIndexedTest: public ArmTest {};

TEST_F(LoadWordImmediatePostIndexedTest, ZeroOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadWordImmediatePostIndexedTest, PositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadWordImmediatePostIndexedTest, NonAlignedPositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadWordImmediatePostIndexedTest, NegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadWordImmediatePostIndexedTest, NonAlignedNegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadWordImmediatePostIndexedTest,
