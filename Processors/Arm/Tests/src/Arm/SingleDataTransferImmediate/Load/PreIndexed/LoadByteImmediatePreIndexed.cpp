...
class LoadByteImmediatePreIndexedTest: public ArmTest {};

TEST_F(LoadByteImmediatePreIndexedTest, ZeroOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadByteImmediatePreIndexedTest, PositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadByteImmediatePreIndexedTest, NonAlignedPositiveOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadByteImmediatePreIndexedTest, NegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadByteImmediatePreIndexedTest, NonAlignedNegativeOffset) {
    Given({
        "PSR is 0,SVC",
        "PC is $00001008",
        "R1 is $00000000",
...
TEST_F(LoadByteImmediatePreIndexedTest,
