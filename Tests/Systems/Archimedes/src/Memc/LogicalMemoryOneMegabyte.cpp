...
class LogicalMemoryTestOneMegabyte : public MemcTest {
public:
    LogicalMemoryTestOneMegabyte() : MemcTest(ONE_MEGABYTE) {}
    ~LogicalMemoryTestOneMegabyte() override = default;
    void SetUp() override {
        MemcTest::SetUp();
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel3AllOperationsFailInUserMode) {
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel2AllOperationsFailInUserMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel1WritesFailInUserMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel0AllOperationSucceedInUserMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordMemcControl({
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel3WritesFailInOperatingSystemMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordMemcControl({
        .operatingSystemMode = MEMC_OS_MODE_ENABLE,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel2WritesFailInOperatingSystemMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordMemcControl({
        .operatingSystemMode = MEMC_OS_MODE_ENABLE,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel1AllOperationSucceedInOperatingSystemMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordMemcControl({
        .operatingSystemMode = MEMC_OS_MODE_ENABLE,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel0AllOperationSucceedInOperatingSystemMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordMemcControl({
        .operatingSystemMode = MEMC_OS_MODE_ENABLE,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel3AllOperationSucceedInSupervisorMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel2AllOperationSucceedInSupervisorMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel1AllOperationSucceedInSupervisorMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, WhenALogicalPageIsMappedWithPageProtectionLevel0AllOperationSucceedInSupervisorMode) {
    const auto physicalPageNumber = 125u;
    const auto logicalPageNumber = 400u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = physicalPageNumber,
...
TEST_F(LogicalMemoryTestOneMegabyte, ContentedLogicalPagesRemainMappedWhenThePhysicalPageIsReassigned) {
...
TEST_F(LogicalMemoryTestOneMegabyte, ContendedLogicalPagesRemainMappedIrrespectiveOfTheOrderInWhichTheyWhereProgrammed) {
    constexpr auto contendedLogicalPage = 8u;
    constexpr auto contendedPhysicalPage = 3u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = 4,
...
TEST_F(LogicalMemoryTestOneMegabyte, ContendedLogicalPagesHaveTheCorrectPageProtectionLevelsAssigned) {
    constexpr auto contendedLogicalPage = 8u;
    constexpr auto contendedPhysicalPage = 3u;
    ASSERT_TRUE(WriteWordAddressTranslator({
        .physicalPageNumber = contendedPhysicalPage,
